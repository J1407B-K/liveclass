...
func (p *UserServiceClient) GetUserInfoByname(ctx context.Context, req *GetUserInfoByNameReq) (r *GetUserInfoByNameResp, err error) {
...
func (p *userServiceProcessorGetUserInfoByname) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	...
	var retval *GetUserInfoByNameResp
	if retval, err2 = p.handler.GetUserInfoByname(ctx, args.Req); err2 != nil {
